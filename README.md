...
Made as a semester project for Windows Programming

## License

This is a learning project. Feel free to use and change it.

---

**Questions or problems?** Check the docs folder or ask for help!
